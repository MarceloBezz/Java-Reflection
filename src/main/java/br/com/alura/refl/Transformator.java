...
public class Transformator {
    ...
    public <I, O> O transform(I input) throws ClassNotFoundException, InstantiationException, IllegalAccessException,
        ...
        Arrays.stream(sourcesFields).forEach(
                sourceField -> Arrays.stream(targetFields).forEach(
                        targetField -> {
